...
echo '
    <div class="blog-post relative overflow--hidden mb--2">
        ...
        <div class="badge badge--destination absolute"><p>'.mb_strimwidth( html_entity_decode($destination), 0, 30, '...' ).'</p></div>
        <div class="badge badge--date-time absolute"><p>Data: '.$wyjazd_date_time.'</p></div>
